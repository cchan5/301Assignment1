...
//
//    public void saveTaskData(Context context, ArrayList<TodoTask> archiveStrArray) {
//   
...
//    }
//
//    public ArrayList<String> loadTaskData(Context context) throws JSONException {
//        
//        SharedPreferences preferences = context.getSharedPreferences(prefs, Context.MODE_PRIVATE);             
//        
//        if (preferences != null) {
...
//    }
//    
//    public JSONArray loadCheckedItems(Context context) throws JSONException {
//    	
//        SharedPreferences preferences = context.getSharedPreferences(prefs2, Context.MODE_PRIVATE);             
//        
//        if (preferences != null) {
